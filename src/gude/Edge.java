...
public class Edge implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1625492442112800086L;
	/**
	 ...
	 *
	 * @param alpha
	 *            id do vertice de partida da aresta
	 * @param omega
	 *            id do vertice de chegada da aresta
	 * @param graph
	 *            grafo que chamou o construtor.
	 *
	 * @see Graph#createEdge(int,int)
	 */
	Edge(int alpha, int omega, Double distancia, Graph graph) {
		this.grafo = graph;
	...
	/**
	 * Dado um dos vértices que definem a aresta, retorna o vértice que está na
	 * outra extremidade dela.
	 *
	 * @param id
	 *            id de um dos vértices que definem a aresta.
	 *
	 * @return o vértice vizinho que está na outra extremidade da aresta, ou
	 *         null se a aresta não incide no vértice id.
	 */
