...
public class Vertex implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3569871514253919712L;
	/**
	...
	Vertex(Graph graph) {
		...
		this.degree = 0;
		edgeList = new TreeMap<Integer, Edge>();
	 ...
	 *
	 * @param aresta
	 *            aresta que será inserida na lista.
	 */
	 ...
	 *
	 * @param id
	 *            id da aresta que sera removida da lista.
	 */
	...
	/**
	 * Retorna a estrela de arestas incidentes no vértice, considerando um grafo
	 * não direcionado.
	 *
	...
	/**
	 * Retorna a primeira aresta incidente no vértice, considerando um grafo não
	 * direcionado.
	 *
	...
	/**
	 * Retorna a próxima aresta incidente no vértice, depois da aresta com chave
	 * id, considerando um grafo não direcionado,
	 *
	 * @param id
	...
	/**
	 * Retorna a próxima aresta de saída incidente no vértice, depois da aresta
	 * com chave idA.
	 *
	 * @param idA
	 *            identificador de aresta.
